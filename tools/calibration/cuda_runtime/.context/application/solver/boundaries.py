...
class EmbeddingTrainer(torch.nn.Module):
    def __init__(self,model,records,upstream='/opt/upstream'):
    ...
    def forward(self,ids,temperature=1.):
        ...
        weights=self.quantizer(temperature).to(self.model.model.embed_tokens.weight.dtype)
