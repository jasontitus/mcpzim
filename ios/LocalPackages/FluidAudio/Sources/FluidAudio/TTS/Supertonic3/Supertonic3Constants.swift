...
public enum Supertonic3Constants {
    ...
    /// utterances. The Latin chunk cap (#669) splits a paragraph into many
    ...
    /// chunk scored 17.6% WER vs 0% at 71 chars). Upstream holds this at 70;
    /// MCPZim uses a measured 96-character compromise to avoid conspicuous
    /// paragraph-reading restarts while remaining below the 105-char failure
    /// case. Longer text is split by `Supertonic3TextChunker` before reaching
    /// the encoder. See #669 and `MCPZIM_PATCHES.md`.
    public static let maxChunkLengthLatin: Int = 96
